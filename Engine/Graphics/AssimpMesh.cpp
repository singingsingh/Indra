...
namespace Engine
{
	namespace Graphics
	{
		...
		bool AssimpMesh::initialize(char* i_modelFilename, const char* i_textureFilename)
		{
			bool result;
		...
		int AssimpMesh::getIndexCount()
		{
			return _indexCount;
		}

		ID3D11ShaderResourceView * AssimpMesh::getTexture()
		{
			return _texture->getTexture();
		}

		bool AssimpMesh::initializeBuffers()
		{
			VertexType* vertices;
		...
		bool AssimpMesh::loadModel(const char* i_modelFileName)
		{
		...
		bool AssimpMesh::loadTexture(const char* i_textureFileName)
		{
			bool result;
