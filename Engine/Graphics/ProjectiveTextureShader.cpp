...
namespace Engine
{
	namespace Graphics
	{
		...
		bool ProjectiveTextureShader::Initialize()
		{
			...
			result = InitializeShader("../Engine/Graphics/Shaders/ProjectiveTextureVS.hlsl", "../Engine/Graphics/Shaders/ProjectiveTexturePS.hlsl");
			if (!result)
			{
				return false;
			}
		...
		bool ProjectiveTextureShader::Render(int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
		...
		bool ProjectiveTextureShader::InitializeShader(const char* vsFilename, const char * psFilename)
		{
			HRESULT result;
			...
			result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "ProjectiveTextureVS", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
			...
			result = D3DX11CompileFromFile(psFilename, NULL, NULL, "ProjectiveTexturePS", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
		...
		void ProjectiveTextureShader::OutputShaderErrorMessage(ID3D10Blob* i_errorMessage, const char* i_shaderFileName)
		{
			char* compileErrors;
			size_t bufferSize, i;
			std::ofstream fout;
		...
		bool ProjectiveTextureShader::SetShaderParameters(D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
