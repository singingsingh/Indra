...
namespace Engine
{
	namespace Graphics
	{
		...
		bool ShadowMappingShader::Initialize()
		{
			bool result;

			// Initialize the vertex and pixel shaders.
			result = InitializeShader("../Engine/Graphics/Shaders/ShadowMappingVS.hlsl", "../Engine/Graphics/Shaders/ShadowMappingPS.hlsl");
			if (!result)
			{
				return false;
			}
		...
		bool ShadowMappingShader::Render(int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
		...
		void ShadowMappingShader::ShutdownShader()
		{
		...
		void ShadowMappingShader::outputShaderErrorMessage(ID3D10Blob* i_errorMessage, const char * i_shaderFileName)
		{
			char* compileErrors;
			size_t bufferSize, i;
			std::ofstream fout;
