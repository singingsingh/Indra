...
namespace Engine
{
	namespace Math
	{
		...
		{
			Assert( !MathUtils::IsNAN( m_11 ) );
			Assert( !MathUtils::IsNAN( i_other.m_11 ) );
		...
		{
			Assert( !MathUtils::IsNAN( m_11 ) );
			Assert(MathUtils::almostEqual( m_41, 0.0f, .000000001f ) );
			Assert(MathUtils::almostEqual( m_42, 0.0f, .000000001f ) );
			Assert(MathUtils::almostEqual( m_43, 0.0f, .000000001f ) );
			Assert(MathUtils::almostEqual( m_44, 1.0f, .000000001f ) );
		...
		{
			Assert( !MathUtils::IsNAN( m_11 ) );
			Assert(MathUtils::almostEqual( m_14, 0.0f, .000000001f ) );
			Assert(MathUtils::almostEqual( m_24, 0.0f, .000000001f ) );
			Assert(MathUtils::almostEqual( m_34, 0.0f, .000000001f ) );
			Assert(MathUtils::almostEqual( m_44, 1.0f, .000000001f ) );
